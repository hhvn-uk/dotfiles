...
alias freebsd.oscss=" ssh -p 22122 hayden@95.217.214.111"
alias sdf=" ssh haydenh@tty.sdf.org"
alias localserve=" ssh void@192.168.1.20"
alias rss=" sfeed_update $XDG_CONFIG_HOME/sfeed/config && SFEED_PLUMBER=urlhand2 sfeed_curses $XDG_CACHE_HOME/sfeed/*"
alias irc=" ssh -Cp 15551 hayden@77.68.91.186"
alias vps2=" ssh -p 15552 hayden@irc.area51.haydenvh.com"
