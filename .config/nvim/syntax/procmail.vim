...
" Modified By:	haydenh <hayden@haydenvh.com>
...
syn include @procmailShell syntax/sh.vim
...
syn region 	procmailActionPipe 	start=+^\s*|+ skip=+\\$+ end=+$+ contains=procmailPipeStart,@procmailShell
...
hi def link 	procmailCondition   	String
...
hi def link 	procmailPipeStart	procmailAction
